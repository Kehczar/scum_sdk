...
void ABP_WeaponSights_M16A4_FoldingSights_C::OnDetachedFromItem(class AItem** Item)
{
...
void ABP_WeaponSights_M16A4_FoldingSights_C::ExecuteUbergraph_BP_WeaponSightBase(int* EntryPoint)
{
