...
public:
	...
	struct FText                                       BloodPressure_kPa;                                        // 0x0328(0x0028) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	struct FText                                       _bloodPressure_mmHg;                                      // 0x0348(0x0028) (Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                               _bloodPressureAlarm;                                      // 0x0360(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void STATIC_ExecuteUbergraph_VitalStatsBloodPressure(int* EntryPoint);
};
