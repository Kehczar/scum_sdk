...
void ABP_WeaponSights_MRO_Red_Dot_C::OnDetachedFromItem(class AItem** Item)
{
...
void ABP_WeaponSights_MRO_Red_Dot_C::ExecuteUbergraph_BP_WeaponSightBase(int* EntryPoint)
{
