...
public:
	...
	unsigned char                                      UnknownData02[0x6];                                       // 0x0272(0x0006) MISSED OFFSET
	...
	unsigned char                                      bAutoPlay : 1;                                            // 0x0288(0x0001) (Deprecated)
	unsigned char                                      bOverrideInstanceData : 1;                                // 0x0288(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bReplicatePlayback : 1;                                   // 0x0288(0x0001) (Edit, BlueprintVisible)
	...
	bool                                               bShowBurnin;                                              // 0x02A0(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnCameraCut;                                              // 0x0870(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0x108];                                     // 0x0880(0x0108) MISSED OFFSET
