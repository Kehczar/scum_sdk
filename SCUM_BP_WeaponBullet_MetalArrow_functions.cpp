...
// (Net, Exec, Native, Event, NetResponse, Static, Private, HasOutParms, NetClient, DLLImport, BlueprintPure, NetValidate)

void ABP_WeaponBullet_MetalArrow_C::STATIC_ReceiveBeginPlay()
{
...
// (NetReliable, Exec, Native, Event, NetResponse, Static, Private, HasOutParms, NetClient, DLLImport, BlueprintPure, NetValidate)
// Parameters:
// int*                           EntryPoint                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_WeaponBullet_MetalArrow_C::STATIC_ExecuteUbergraph_BP_WeaponBullet_MetalArrow(int* EntryPoint)
{
