...
public:
	...
	uint32_t                                           ObjectFlags;                                              // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
	...
	static inline TArray<UObject*>& UObject::GetGlobalObjects()
	{
...
public:
	...
	unsigned char                                      UnknownData00[0x48];                                      // 0x0000(0x0000) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData00[0x178];                                     // 0x0098(0x0178) MISSED OFFSET
