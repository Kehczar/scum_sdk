...
// (NetReliable, Exec, NetResponse, Public, Private, Protected, NetServer, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (Net, NetRequest, Exec, Native, Event, Static, NetMulticast, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
// Parameters:
...
// (NetRequest, Native, Event, Static, NetMulticast, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
// Parameters:
...
// (Net, NetReliable, NetRequest, Native, Event, Static, NetMulticast, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
// Parameters:
...
// (Event, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
// Parameters:
...
// (NetRequest, Native, Event, NetResponse, MulticastDelegate, Private, Delegate, HasDefaults, BlueprintEvent, BlueprintPure, Const, NetValidate)
// Parameters:
// class APrisoner*               Prisoner                       (Parm, OutParm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, Exec, NetResponse, Public, Private, Protected, NetServer, BlueprintEvent, BlueprintPure)
...
// (Net, NetRequest, Exec, NetResponse, Public, Private, Protected, NetServer, BlueprintEvent, BlueprintPure)
...
// (NetRequest, Exec, NetResponse, Public, Private, Protected, NetServer, BlueprintEvent, BlueprintPure)
...
// (Net, NetReliable, Exec, NetResponse, Public, Private, Protected, NetServer, BlueprintEvent, BlueprintPure)
// Parameters:
