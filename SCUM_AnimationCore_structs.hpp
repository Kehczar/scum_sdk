...
enum class ETransformConstraintType : uint8_t
{
	...
	None                           = 1,
	ETransformConstraintType__Rotation = 2,
	neByteProperty‘IntProperty  = 3,
	ETransformConstraintType__Scale = 4,
	ByteProperty‘IntProperty    = 5,
	ETransformConstraintType__Parent = 6,
	ByteProperty                   = 7,
	ETransformConstraintType__ETransformConstraintType_MAX = 8,
