...
public:
	...
	struct FScriptMulticastDelegate                    Continue;                                                 // 0x0258(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
	struct FScriptMulticastDelegate                    New;                                                      // 0x0268(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
	...
	void Init();
	void STATIC_ExecuteUbergraph_UI_ContinueOrNewCharacterDialog(int* EntryPoint);
