...
public:
	...
	struct FText                                       Text;                                                     // 0x0270(0x0028) (Edit, BlueprintVisible)
	...
	struct FScriptMulticastDelegate                    OnClicked;                                                // 0x0290(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
	...
	void STATIC_ExecuteUbergraph_UI_SortByButton(int* EntryPoint);
