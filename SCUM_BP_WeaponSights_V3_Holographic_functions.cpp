...
void ABP_WeaponSights_V3_Holographic_C::OnDetachedFromItem(class AItem** Item)
{
...
void ABP_WeaponSights_V3_Holographic_C::ExecuteUbergraph_BP_WeaponSightBase(int* EntryPoint)
{
