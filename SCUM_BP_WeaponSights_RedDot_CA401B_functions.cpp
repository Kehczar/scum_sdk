...
void ABP_WeaponSights_RedDot_CA401B_C::OnDetachedFromItem(class AItem** Item)
{
...
void ABP_WeaponSights_RedDot_CA401B_C::ExecuteUbergraph_BP_WeaponSightBase(int* EntryPoint)
{
