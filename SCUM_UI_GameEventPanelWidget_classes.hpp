...
public:
	...
	bool                                               HighlightedCurrent;                                       // 0x02D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void UpdateSelection(class UComboBoxString** Dropdown, struct FString* Selected, TArray<class AGameEventBase*>* GameEvents);
	...
	void OnOpened();
	void OnClosed();
	void OnEventComboBoxSelectionChanged(struct FString* SelectedItem, TEnumAsByte<ESelectInfo>* SelectionType);
