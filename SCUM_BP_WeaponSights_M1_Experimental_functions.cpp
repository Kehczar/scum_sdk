...
void ABP_WeaponSights_M1_Experimental_C::OnDetachedFromItem(class AItem** Item)
{
...
void ABP_WeaponSights_M1_Experimental_C::ExecuteUbergraph_BP_WeaponSightBase(int* EntryPoint)
{
