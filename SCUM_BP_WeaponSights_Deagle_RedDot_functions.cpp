...
void ABP_WeaponSights_Deagle_RedDot_C::OnDetachedFromItem(class AItem** Item)
{
...
void ABP_WeaponSights_Deagle_RedDot_C::ExecuteUbergraph_BP_WeaponSightBase(int* EntryPoint)
{
